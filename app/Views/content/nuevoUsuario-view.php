		  	...
		  	<div class="column">
		    	<div class="control">
					<label>tipo Usuario</label>
				  	<input class="input" type="text" name="usuario_tipo" pattern="[1-4]" maxlength="20" required >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
		  	...
		  	<div class="column">
		    	<div class="control">
					<label>Contraseña</label>
				  	<input class="input" type="password" name="usuario_clave_1" pattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?!.*\s).*$" maxlength="100" required >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
					<label>Repetir Contraseña</label>
				  	<input class="input" type="password" name="usuario_clave_2" pattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?!.*\s).*$" maxlength="100" required >
				</div>
		  	</div>
		</div>
		<div class="columns">
            <div class="column">
		    	<div class="control">
					<label>RUT</label>
				  	<input class="input" type="text" name="usuario_RUT"  maxlength="40" required >
				</div>
		  	</div>
		  	<div class="column">
